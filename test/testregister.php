        ...
        <section>
            <div id="content">
                <p>
                    ...
                    // This script performs an INSERT query that adds a record to the SFT_utenteRegistrato table.
                    if (isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        // e stato scelto uno username?
                        if (empty($_POST['username'])) {
                            $errors[] = 'Non hai scelto uno username.';
                        } else {
                        ...
                        if (empty($errors)) { // If no problems encountered, register the user in the database
                            ...
                            // Make the query
                            $q = "INSERT INTO fi_licursi.SFT_utenteRegistrato (nome, cognome, email, password, registration_date, username)
                                  VALUES ('$fn', '$ln', '$e', SHA1('$p'), NOW(), '$un')";
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    <p><label class="label" for="nome">First Name:</label>
                        <input id="nome" type="text" name="nome" size="30" maxlength="30" value="<?php if (isset($_POST['nome'])) echo htmlspecialchars($_POST['nome']); ?>">
                    </p>
                    <p><label class="label" for="cognome">Last Name:</label>
                        <input id="cognome" type="text" name="cognome" size="30" maxlength="40" value="<?php if (isset($_POST['cognome'])) echo htmlspecialchars($_POST['cognome']); ?>">
                    </p>
                    <p><label class="label" for="email">Email Address:</label>
                        <input id="email" type="text" name="email" size="30" maxlength="60" value="<?php if (isset($_POST['email'])) echo htmlspecialchars($_POST['email']); ?>">
                    </p>
                    <p><label class="label" for="username">Username:</label>
                        <input id="username" type="text" name="username" size="30" maxlength="60" value="<?php if (isset($_POST['username'])) echo htmlspecialchars($_POST['username']); ?>">
                    </p>
                    <p><label class="label" for="password">Password:</label>
                        <input id="password" type="password" name="password" size="12" maxlength="12" value="<?php if (isset($_POST['password'])) echo htmlspecialchars($_POST['password']); ?>">&nbsp;
                        Between 8 and 12 characters.
                    </p>
                    <p><label class="label" for="password2">Confirm Password:</label>
                        <input id="password2" type="password" name="password2" size="12" maxlength="12" value="<?php if (isset($_POST['password2'])) echo htmlspecialchars($_POST['password2']); ?>">
                    </p>
